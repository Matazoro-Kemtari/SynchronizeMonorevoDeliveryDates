...
// Source: .\reportsetting.go

// Package mock_reportsetting is a generated GoMock package.
package mock_reportsetting

import (
	reportsetting "SynchronizeMonorevoDeliveryDates/usecase/reportsetting"
	reflect "reflect"
...
func (m *MockSettingLoader) Load(path string) (*reportsetting.ReportSettingDto, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Load", path)
	ret0, _ := ret[0].(*reportsetting.ReportSettingDto)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
