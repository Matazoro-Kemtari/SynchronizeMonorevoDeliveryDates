...
// Source: .\appsetting_obtain_case.go

// Package mock_appsetting_obtain_case is a generated GoMock package.
package mock_appsetting_obtain_case

import (
	appsetting_obtain_case "SynchronizeMonorevoDeliveryDates/usecase/appsetting_obtain_case"
	reflect "reflect"
...
func (m *MockSettingLoader) Load(path string) (*appsetting_obtain_case.AppSettingDto, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Load", path)
	ret0, _ := ret[0].(*appsetting_obtain_case.AppSettingDto)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
