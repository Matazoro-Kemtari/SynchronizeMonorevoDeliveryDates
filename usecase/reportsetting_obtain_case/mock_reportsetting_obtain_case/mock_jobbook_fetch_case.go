...
// Source: .\reportsetting_obtain_case.go

// Package mock_reportsetting_obtain_case is a generated GoMock package.
package mock_reportsetting_obtain_case

import (
	reportsetting_obtain_case "SynchronizeMonorevoDeliveryDates/usecase/reportsetting_obtain_case"
	reflect "reflect"
...
func (m *MockSettingLoader) Load(path string) (*reportsetting_obtain_case.ReportSettingDto, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Load", path)
	ret0, _ := ret[0].(*reportsetting_obtain_case.ReportSettingDto)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
